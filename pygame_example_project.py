...
shape_position = (width / 2, height / 2) # (x, y) in pixels
shape_size = (100, 100) # (width, height) in pixels
...
while True:
    ...
    # Experiment: Move circle right 1 px each frame
    # Equivalently, smoothly animate moving 60 px per sec
